...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="Run receiving data pipeline")
    ...
    # 1) Run receiving_extraction.py with parameters
    run("receiving_extraction.py", "--year", args.year, "--week", args.week, "--phase", args.phase, "--sort_hash", args.sort_hash, "--output", args.output)
