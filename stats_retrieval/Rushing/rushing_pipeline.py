...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="Run rushing data pipeline")
    ...
    # 1) Run rushing_extraction.py with parameters
    run("rushing_extraction.py", "--year", args.year, "--week", args.week, "--phase", args.phase, "--sort_hash", args.sort_hash, "--output", args.output)
